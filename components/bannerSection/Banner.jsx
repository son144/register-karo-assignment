    ...
    <div className="w-full relative">
      ...
      <div className="absolute left-[50%] top-[50%] transform -translate-x-[50%] -translate-y-[50%]   h-[calc(100%-85px)] md:h-[calc(100%-165px)] w-full flex justify-center items-center ">
        <div className='w-full '>
          <div>
            <p className='text-white sm:text-center mb-2 font-semibold sm:text-xl text-lg sm:w-full w-[80%] m-auto text-start  sm:block hidden'>From a single desk to a whole building. The choice is yours.</p>
            <div className='text-white sm:hidden flex flex-col items-center sm:text-center mb-2 font-semibold sm:text-xl text-base sm:w-full w-[70%] m-auto text-start '>
              <p>From a single desk to a whole</p>
              <p>building. The choice is yours.</p>
            </div>
            <h4 className='text-white text-center md:text-5xl text-3xl sm:font-semibold font-medium mb-6'>Discover the Ultimate Workspace Solution</h4>
          </div>
          <div className='md:w-[75%] lg:w-[40%] sm:w-[60%] w-[90%] m-auto'>
            ...
            <div className=" bg-[#F4F3F0] border overflow-hidden rounded-2xl px-3 py-3  gap-3 sm:hidden block">
              ...
              <p className='text-primary text-sm underline pb-1 text-end mt-1'>Search Nearby</p>
            </div>
            <div className='px-10'>
              <h5 className='sm:text-base text-sm text-white  font-semibold mt-6 mb-6 sm:text-start text-center'>Trending cities</h5>
